...
MENSAJE_PRUEBA = "Mandame el promedio delos datos de la columna 6 de la 'Hoja 1' del archivo de hoja de calculo bonos ti 20251, y edita el archivo para poner el promedio al final de la columna"
